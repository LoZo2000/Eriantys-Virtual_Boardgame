...
public class GameManager {
    ...
    private void manageADD(Connection c, Message message) throws IllegalMessageException, NoActiveCardException, IllegalActionException, NotYourTurnException, IllegalMoveException, UnrecognizedPlayerOrActionException, CannotJoinException, NoCharacterSelectedException, EndGameException, NotEnoughMoneyException, NoMoreTokensException {
